          ...
          child: Center(
            child: Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: const DecorationImage(
                      image: AssetImage('assets/fries5.png'),
                      fit: BoxFit.fitWidth,
                    ),
                    color: Colors.orange,
                ...
                Center(child: Text('\$4.99',style: TextStyle(fontSize:18,fontWeight:FontWeight.w900,color: Colors.white),)),
                SizedBox(height: screenHeight * 0.02),
                Row(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Ketchup', style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.w500, color: Colors.amber)),
                      Text('Potatoes', style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.w500, color: Colors.amber)),
                      Text('Mayonnaise', style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.w500, color: Colors.amber)),
                      Text('Oil for frying', style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.w500, color: Colors.amber)),
                    ],
                  ),
                ),
              ],
